        ...
        <div style={{ 
          ...
          <button
            ...
            style={{
              ...
              fontWeight: "bold",
              background: activeTab === "songs" ? "var(--game-accent-blue)" : "transparent",
              color: activeTab === "songs" ? "white" : "var(--game-text-secondary)",
              border: "none",
              borderBottom: activeTab === "songs" ? `var(--border-width-md) solid var(--game-accent-blue)` : `var(--border-width-md) solid transparent`,
              cursor: "pointer",
          ...
          <button
            ...
            style={{
              ...
              fontSize: "var(--font-size-sm)",
              fontWeight: "bold",
              background: activeTab === "images" ? "var(--game-accent-blue)" : "transparent",
              color: activeTab === "images" ? "white" : "var(--game-text-secondary)",
              border: "none",
              borderBottom: activeTab === "images" ? `var(--border-width-md) solid var(--game-accent-blue)` : `var(--border-width-md) solid transparent`,
              cursor: "pointer",
              textTransform: "uppercase",
              transition: "all var(--transition-fast)",
            }}
