    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-sm)", alignItems: "center" }}>
      ...
      <div style={{ 
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "var(--space-xs)" }}>
          <div style={{ width: "12px", height: "12px", background: currentColor, border: "1px solid var(--game-border)" }} />
          <span>CURR</span>
        </div>
        
        <div style={{ display: "flex", alignItems: "center", gap: "var(--space-xs)" }}>
          <span>NEW</span>
          <div style={{ width: "12px", height: "12px", background: hoverColor || currentColor, border: "1px solid var(--game-border)" }} />
        </div>
      </div>
    </div>
  );
